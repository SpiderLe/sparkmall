package com.king.yl.mockdata

import java.text.SimpleDateFormat
import java.util.{Date, UUID}

import com.king.yl.datamode.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
import com.king.yl.util.{RanOpt, RandomDate, RandomNum, RandomOptions}
